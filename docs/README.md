...
```
github.com/Kolterdyx/rt-goNEAT/alife        — simulation controller
github.com/Kolterdyx/rt-goNEAT/neat          — options, context
github.com/Kolterdyx/rt-goNEAT/neat/genetics — genome, organism, species, population
github.com/Kolterdyx/rt-goNEAT/neat/network  — neural network phenotype
github.com/Kolterdyx/rt-goNEAT/neat/math     — activation functions
```
